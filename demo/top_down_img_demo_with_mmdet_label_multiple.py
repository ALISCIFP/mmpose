...
def main():
    ...
    canvas_name = '/home/zs/github/mmpose/demo/cnavas-mid.png'
    image_names = sorted([f for f in glob.glob(args.img_root + "/*.png")])
    print(image_names[0])
    NumFrames = len(image_names)
    ...
    for image_name in image_names:
        ...
        out_file = os.path.join(args.out_img_root, f'{image_name_base}')
